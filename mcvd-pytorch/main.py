...
def parse_args_and_config():
    ...
    parser.add_argument('--feats_dir', type=str, default=os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                                                      'datasets'),
                        help='Path to directory containing InceptionV3 feats pt files')
    parser.add_argument('--stats_dir', type=str, default=os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                                                      'datasets'),
